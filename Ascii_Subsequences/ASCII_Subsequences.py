...
- For example:-
Take as input string1, a string. We are concerned with all the possible ASCII-subsequences of string1. E.g. “ab” has following ASCII-subsequences “”, “b”, “98”, “a”, “ab”, “a98”, “97”, “97b”, “9798”
...
def subseq(s, i, string1):
    ...
    subseq(s, i + 1, string1) # First function call
    subseq(s + string1[i], i + 1, string1) # Second function call
    subseq(s + str(ord(string1[i])),i + 1, string1) #Third function call 
    # ord(string1[i]) gives the ASCII value which is then converted to string for concatenation
