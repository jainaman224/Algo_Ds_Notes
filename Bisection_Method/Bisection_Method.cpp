...
int main()
{
    ...
    {   // repeat until the required accuracy is obtained
        ...
        {
            cout << "\nIteration_no = " << i << " ,First_no = " << lower_bound << " ,Second_no = " << upper_bound << " middle = " << mid(lower_bound, upper_bound) ;
            cout << " ,f(middle) = " << polynomial(mid(lower_bound, upper_bound)) << " ,f(first_no)*f(middle) = " << polynomial(lower_bound)*polynomial(mid(lower_bound, upper_bound)) << endl;
        ...
        cout << "\nIteration_no = " << i << " ,First_no = " << lower_bound << " ,Second_no = " << upper_bound << " middle = " << mid(lower_bound, upper_bound) ;
        cout << " ,f(middle) = " << polynomial(mid(lower_bound, upper_bound)) << " ,f(first_no)*f(middle) = " << polynomial(lower_bound)*polynomial(mid(lower_bound, upper_bound)) << endl;
        cout << "\nThe approximated root of the given polynomial within the specified interval (" << a << " , " << b << ") = " ;
