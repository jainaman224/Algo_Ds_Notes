...
public class Aggressive_Cows {
	...
	public static void main(String[] args) {
		...
		// in this problem we have to maximise the minimum distance between the cows
		// since minimum distance is being linearly checked we apply binary search on
		// minimum
		// distance
		...
		int[] arr = new int[nos]; // storing the positions of stalls in an array
		...
		int lo = 0;
		int hi = arr[arr.length - 1] - arr[0]; // it is equal to possible max distance between two cows
