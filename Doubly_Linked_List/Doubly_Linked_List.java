...
class Doubly_Linked_List {
    ...
    void display() {
	    ...
	    // Traverse over doubly linked list and print the elements
	...
	/*
	 * Sample Input 1: lst.addFirst(10) lst.addLast(30) lst.addAt(20,1);
	 * lst.display(); => 10, 20, 30 lst.removeFirst(); lst.removeLast();
	 * lst.display(); => 20
	 */
