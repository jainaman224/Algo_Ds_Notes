...
def is_possible(sudoku,row,col,num):
    ...
    row_num_of_box = int(floor(row/3))*3 # row number of first cell of the corresponding 3*3 box
    col_num_of_box = int(floor(col/3))*3 # column number of first cell of the corresponding 3*3 box
