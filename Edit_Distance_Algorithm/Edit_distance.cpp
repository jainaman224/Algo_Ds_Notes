...
int Edit_Distance(string a , string b , int size1 ,int size2) 
{ 
    ...
    if (a[size1-1] == b[size2-1]) 
        return Edit_Distance(a, b, size1-1, size2-1); 
     ...
     */
    return 1 + min ( Edit_Distance(a,  b, size1, size2-1),    // Insert 
                     Edit_Distance(a,  b, size1-1, size2),    // Resize1ove 
                     Edit_Distance(a,  b, size1-1, size2-1)  // Replace 
                   ); 
} 
