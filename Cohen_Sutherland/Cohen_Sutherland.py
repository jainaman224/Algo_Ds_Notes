...
def CohenSutherlandClipping(x1, y1, x2, y2): 
	...
	while True: 
		...
		# Some portion of line lies inside the rectangle and rest outside the rectangle
		else: 

			# Line Needs clipping 
			# At least one of the points is outside the rectangle, therefore select it, 
			x = 1.0
			y = 1.0
			if p != 0: 
				point_out = p 
...
# Sample Input 1
# CohenSutherlandClipping(14, 20, 11, 12)
# Output 1
# The line accepted from 12.88,17.00 to 12.00,14.67

# Sample Input 2
# CohenSutherlandClipping(4,6, 7, 8)
# Output 2
