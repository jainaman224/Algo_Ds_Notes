...
int optimalStrategyOfGame(int* arr, int n)
{
    ...
    // that the table is filled in diagonal fashion from diagonal elements to table[0][n-1] which is the result.
...
int main()
{
    ...
    cin>>n;                                //Number of values in array you want to store

    for(int i =0; i < n; i++)              //Input taken in array
         cin>>arr1[i];

    printf("%d\n", optimalStrategyOfGame(arr1, n));          //function call for calculating it's optimal strategy
